...
class application:
   ...
   # def plot(self, training, target, color, )
    
    #def evaluate(self, validation_data, metric,device = 'cpu', parallel = False ):
        
    
   # def bridge(self, n, initial, end, device = 'cpu', parallel = False):
